...
if (file_exists(__DIR__ . '/../backend/php/config.php')) {
    try {
...
$diagnostics['permissions'] = [
    ...
    'config_readable' => is_readable(__DIR__ . '/../backend/php/config.php'),
    'includes_readable' => is_readable(__DIR__ . '/../backend/php/includes/'),
];
